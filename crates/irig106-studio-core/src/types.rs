...
impl DataType {
    ...
    pub fn from_u8(value: u8) -> Option<Self> {
        ...
        match value {
            ...
            0x09 => Some(Self::PcmFmtA),
            0x0A => Some(Self::PcmFmtB),
            0x11 => Some(Self::Time),
            0x19 => Some(Self::Mil1553FmtA),
            0x1A => Some(Self::Mil1553FmtB),
            0x21 => Some(Self::Analog),
            0x29 => Some(Self::Discrete),
            0x30 => Some(Self::Message),
            0x38 => Some(Self::Arinc429),
            0x40 => Some(Self::VideoFmtA),
            0x41 => Some(Self::VideoFmtB),
            0x48 => Some(Self::ImageFmtA),
            0x50 => Some(Self::Uart),
            0x58 => Some(Self::Ieee1394),
            0x60 => Some(Self::ParallelDC),
            0x68 => Some(Self::EthernetFmtA),
            0x69 => Some(Self::EthernetFmtB),
            0x70 => Some(Self::Tspi),
            0x78 => Some(Self::Can),
